...
const SampleComponent = (props) => {
    ...
    const OptionItemDICT_NETWORK_MANAGERS = (props) => {
        ...
        return(
            <option
                selected={props.optionItem.manager_id == props.manager_name ? 'selected' : ''}
    ...
    return(
        <div className="twoLevel">
            <div className="innerBlock">
                ...
                <input  api_name="ident_code" entity_id={props.data.entity_id} onChange={(e) => props.changeInputSC(e)}  value={props.data.ident_code} id="ident_code" type="text" className="form-control"/>
                <label htmlFor="entity_name" >Назва 2-го рівня</label>
                <input api_name="entity_name" entity_id={props.data.entity_id} onChange={(e) => props.changeInputSC(e)} value={props.data.entity_name} id="entity_name" type="text" className="form-control"/>
                <label htmlFor="brand_id">Менеджер</label>
                <select  id="dropdown-basic-button" entity_id={props.data.entity_id} onChange={(e) => props.changeInputSC(e)} api_name="manager_name" className="form-select" title="ТВБВ">
                    <option>-</option>
                    {
                        props.DICT_NETWORK_MANAGERS.map((item, index) => {
                            return < OptionItemDICT_NETWORK_MANAGERS key={index} optionItem={item} manager_name={props.data.manager_name}/>
                        })
                    }
                </select>
            </div>
...
const OptionItemDICT_NET_CLIENT_STATUS= (props) => {
   // console.log( props )
    return(
        <option selected={props.optionItem.status_code == props.status_code ? 'selected' : ''}  value={props.optionItem.status_code} >{props.optionItem.status_name}</option>
        // <Dropdown.Item  onClick={() => this.selectRoleID} value={props.optionItem.role_id} >{props.optionItem.role_name}</Dropdown.Item>
    )
}
const OptionItemDICT_NETWORK_MANAGERS = (props) => {
        ...
        return (
            <div className="coverTable DICT_NET_BRAND">
                            ...
                            <option>-</option>
                            {
                                this.state.isShowDICT_NET_CLIENT_STATUS
                                    ? this.state.DICT_NET_CLIENT_STATUS.map((item, index) => {
                                        return < OptionItemDICT_NET_CLIENT_STATUS key={index} optionItem={item} status_code={this.state.brand_status_code}/>
                                    })
                                    : <></>
                            }
                        </select>
                            ...
                            <option>-</option>
                            {
                                this.state.isShowSelectDICT_INSTITUTION
                                    ...
                                    this.state.DICT_INSTITUTION.map((item, index) => {
                                        return < OptionItemDICT_INSTITUTION key={index} optionItem={item} institution_id={this.state.brand_region}/>
                                    })
                                    : <>
                                    </>
                            }
                    ...
                    <div className="coverInputs contactPerson">
                        ...
                        <div className="innerBlock">
                            <div className="coverInput">
                                ...
                                <input disabled={this.state.isDisableInput ? 'disabled' : ''} onChange={this.changeInput}
                                       api_name="contact_person" className="customInput form-control" id="date_from" type="text"
                            ...
                            <div className="coverInput">
                                ...
                                <input disabled={this.state.isDisableInput ? 'disabled' : ''} onChange={this.changeInput}
                                       api_name="contact_position" className="customInput form-control" id="date_to" type="text"
                            ...
                            <div className="coverInput">
                                ...
                                {/*/>*/}
                                <input disabled={this.state.isDisableInput ? 'disabled' : ''} onChange={this.changeInput}
                                       api_name="contact_email" className={`${this.state.isContact_emailError ? 'errorEmail' : ''} customInput form-control`}
                                       id="email" type="text" value={this.state.contact_email}
                                />
                                {/*{*/}
                ...
                <div className="coverBtn">
                    <button className="btn btn-success" disabled={this.state.isDisabledSaveBtn ? 'disabled' : ''} onClick={this.save}>Зберегти мережу</button>
                </div>
